...
import com.liujs.demo.okhttpdemo.base.BaseFragment;
import com.liujs.demo.okhttpdemo.model.NewsModel;
...
public class NewsTabFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    @Bind(com.liujs.demo.R.id.recyclerView)
    RecyclerView recyclerView;
    @Bind(com.liujs.demo.R.id.refreshLayout)
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.liujs.demo.R.layout.fragment_tab, container, false);
                ...
                .execute(new NewsCallback<NewsModel>(NewsModel.class) {
                    ...
                    public void onSuccess(NewsModel newsModel, Call call, Response response) {
                        ...
                        if (newsModel.pagebean.allPages == currentPage) {
                            ...
                            View noDataView = inflater.inflate(com.liujs.demo.R.layout.item_no_data, (ViewGroup) recyclerView.getParent(), false);
