...
package com.liujs.library.view.refresh;
...
public class BGANormalRefreshViewHolder extends BGARefreshViewHolder {
    ...
    public View getRefreshHeaderView() {
        if (mRefreshHeaderView == null) {
            mRefreshHeaderView = View.inflate(mContext, com.liujs.library.R.layout.view_refresh_header_normal, null);
            ...
            mHeaderStatusTv = (TextView) mRefreshHeaderView.findViewById(com.liujs.library.R.id.tv_normal_refresh_header_status);
            mHeaderArrowIv = (ImageView) mRefreshHeaderView.findViewById(com.liujs.library.R.id.iv_normal_refresh_header_arrow);
            mHeaderChrysanthemumIv = (ImageView) mRefreshHeaderView.findViewById(com.liujs.library.R.id.iv_normal_refresh_header_chrysanthemum);
