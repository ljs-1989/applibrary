...
public class BGAMoocStyleRefreshViewHolder extends BGARefreshViewHolder {
    ...
    public View getRefreshHeaderView() {
        if (mRefreshHeaderView == null) {
            mRefreshHeaderView = View.inflate(mContext, com.liujs.library.R.layout.view_refresh_header_mooc_style, null);
            ...
            mMoocRefreshView = (BGAMoocStyleRefreshView) mRefreshHeaderView.findViewById(com.liujs.library.R.id.moocView);
