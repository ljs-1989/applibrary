...
public class BGAStickinessRefreshViewHolder extends BGARefreshViewHolder {
    ...
    public View getRefreshHeaderView() {
        if (mRefreshHeaderView == null) {
            mRefreshHeaderView = View.inflate(mContext, com.liujs.library.R.layout.view_refresh_header_stickiness, null);
            ...
            mStickinessRefreshView = (BGAStickinessRefreshView) mRefreshHeaderView.findViewById(com.liujs.library.R.id.stickinessRefreshView);
