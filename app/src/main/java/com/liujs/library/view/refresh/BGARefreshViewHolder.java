...
public abstract class BGARefreshViewHolder {
    ...
    public View getLoadMoreFooterView() {
        ...
        if (mLoadMoreFooterView == null) {
            mLoadMoreFooterView = View.inflate(mContext, com.liujs.library.R.layout.view_normal_refresh_footer, null);
            ...
            mFooterStatusTv = (TextView) mLoadMoreFooterView.findViewById(com.liujs.library.R.id.tv_normal_refresh_footer_status);
            mFooterChrysanthemumIv = (ImageView) mLoadMoreFooterView.findViewById(com.liujs.library.R.id.iv_normal_refresh_footer_chrysanthemum);
